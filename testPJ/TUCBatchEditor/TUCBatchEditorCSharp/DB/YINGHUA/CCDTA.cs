...
namespace TUCBatchEditorCSharp.DB.YINGHUA
{
    enum STSN_CODE
    {
        /// <summary>
    ...
    class CCDTA : IEditable
    {
        ...
        /// 批次號
        /// </summary>
        [FieldInfoAttribute("工單號", true, true, typeof(TextBox))]
        ...
        /// 參數編碼
        /// </summary>
        [FieldInfoAttribute("檢測設定", true, false, typeof(ComboBox))]
        public string PARAM { get; set; }
        /// <summary>
        /// 工單產品長度
        /// </summary>
        [FieldInfoAttribute("工單產品長度", true, false, null)]
        ...
        public string GetName() { return PNAME + LOTSN; }
        #endregion
    }
