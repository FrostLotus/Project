...
CSystCCLProcessSUZHOU::CSystCCLProcessSUZHOU()
{
#ifdef _DEBUG
		...
		const PLC_DATA_ITEM_ ctSYST_PLC_FIELD[FIELD_MAX] = {
			{ L"工單",				FIELD_ORDER,				PLC_TYPE_STRING,	ACTION_BATCH,		10,		L"D",		ctBASE_ADDRESS + 1500 },
			{ L"料號",				FIELD_MATERIAL,				PLC_TYPE_STRING,	ACTION_BATCH,		18,		L"D",		ctBASE_ADDRESS + 1534 },
			{ L"模號",				FIELD_MODEL,				PLC_TYPE_STRING,	ACTION_BATCH,		10,		L"D",		ctBASE_ADDRESS + 1529 },
			{ L"分發號",			FIELD_ASSIGN,				PLC_TYPE_STRING,	ACTION_BATCH,		10,		L"D",		ctBASE_ADDRESS + 1505 },
			{ L"分發號數量",		FIELD_ASSIGNNUM,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1510 },
			{ L"一開幾數",			FIELD_SPLITNUM,				PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1511 },
			{ L"第一張大小板長",	FIELD_SPLIT_ONE_Y,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1512 },
			{ L"第二張大小板長",	FIELD_SPLIT_TWO_Y,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1514 },
			{ L"第三張大小板長",	FIELD_SPLIT_THREE_Y,		PLC_TYPE_WORD,		ACTION_SKIP,		2,		L"D",		0 },
			{ L"第一張大小板寬",	FIELD_SPLIT_ONE_X,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1513 },
			{ L"第二張大小板寬",	FIELD_SPLIT_TWO_X,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1515 },
			{ L"第三張大小板寬",	FIELD_SPLIT_THREE_X,		PLC_TYPE_WORD,		ACTION_SKIP,		2,		L"D",		0 },
			{ L"板材厚度",			FIELD_THICK_SIZE,			PLC_TYPE_FLOAT,		ACTION_BATCH,		4,		L"D",		ctBASE_ADDRESS + 1516 },
			{ L"銅箔厚度",			FIELD_THICK_CCL,			PLC_TYPE_FLOAT,		ACTION_BATCH,		4,		L"D",		ctBASE_ADDRESS + 1518 },
			{ L"銅箔特性",			FIELD_CCL_TYPE,				PLC_TYPE_STRING,	ACTION_BATCH,		6,		L"D",		ctBASE_ADDRESS + 1520 },  
			{ L"灰度值",			FIELD_CCL_GRAYSCALE,		PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1525 },
			{ L"點值要求(AA版點值)",FIELD_LEVEL_AA_PIXEL,		PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1526 },
			{ L"點值要求(A版點值)",	FIELD_LEVEL_A_PIXEL,		PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1527 },
			{ L"點值要求(P版點值)",	FIELD_LEVEL_P_PIXEL,		PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1528 },
			...
			{ L"第一個大小版經向公差下限",	FIELD_DIFF_ONE_Y_MIN,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1544 },
			{ L"第一個大小版經向公差上限",	FIELD_DIFF_ONE_Y_MAX,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1545 },
			{ L"第一個大小版緯向公差下限",	FIELD_DIFF_ONE_X_MIN,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1546 },
			{ L"第一個大小版緯向公差上限",	FIELD_DIFF_ONE_X_MAX,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1547 },
			{ L"第一個大小版對角線公差下限",FIELD_DIFF_ONE_XY_MIN,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1548 },
			{ L"第一個大小版對角線公差上限",FIELD_DIFF_ONE_XY_MAX,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1549 },
			{ L"第二個大小版經向公差下限",	FIELD_DIFF_TWO_Y_MIN,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1550 },
			{ L"第二個大小版經向公差上限",	FIELD_DIFF_TWO_Y_MAX,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1551 },
			{ L"第二個大小版緯向公差下限",	FIELD_DIFF_TWO_X_MIN,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1552 },
			{ L"第二個大小版緯向公差上限",	FIELD_DIFF_TWO_X_MAX,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1553 },
			{ L"第二個大小版對角線公差下限",FIELD_DIFF_TWO_XY_MIN,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1554 },
			{ L"第二個大小版對角線公差上限",FIELD_DIFF_TWO_XY_MAX,	PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",	ctBASE_ADDRESS + 1555 },
			...
			{ L"小版AA級數量",		FIELD_AA_NUM,				PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1640 },
			{ L"指令下發",			FIELD_CCL_COMMAND,			PLC_TYPE_WORD,		ACTION_NOTIFY,		2,		L"D",		ctBASE_ADDRESS + 1558 },

			{ L"C06小板剪切編號",	FIELD_CCL_NO_C06,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1557 },
			{ L"C10小板剪切編號",	FIELD_CCL_NO_C10,			PLC_TYPE_WORD,		ACTION_NOTIFY,		2,		L"D",		ctBASE_ADDRESS + 1556 },
			{ L"C12小板剪切編號",	FIELD_CCL_NO_C12,			PLC_TYPE_WORD,		ACTION_BATCH,		2,		L"D",		ctBASE_ADDRESS + 1559 },
		
			{ L"小板實際長度1",		FIELD_REAL_Y_ONE,				PLC_TYPE_FLOAT,		ACTION_RESULT,		4,		L"D",		ctBASE_ADDRESS + 1647 },
			{ L"小板實際長度2",		FIELD_REAL_Y_TWO,				PLC_TYPE_FLOAT,		ACTION_RESULT,		4,		L"D",		ctBASE_ADDRESS + 1649 },
			{ L"小板實際寬度1",		FIELD_REAL_X_ONE,				PLC_TYPE_FLOAT,		ACTION_RESULT,		4,		L"D",		ctBASE_ADDRESS + 1651 },
			{ L"小板實際寬度2",		FIELD_REAL_X_TWO,				PLC_TYPE_FLOAT,		ACTION_RESULT,		4,		L"D",		ctBASE_ADDRESS + 1653 },
			{ L"小板長度實際公差1", FIELD_REAL_DIFF_ONE_Y,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1574 },
			{ L"小板長度實際公差2", FIELD_REAL_DIFF_TWO_Y,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1575 },
			{ L"小板寬度實際公差1", FIELD_REAL_DIFF_ONE_X,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1576 },
			{ L"小板寬度實際公差2", FIELD_REAL_DIFF_TWO_X,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1577 },
			{ L"小板對角線實際公差1", FIELD_REAL_DIFF_ONE_XY,		PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1578 },
			{ L"小板對角線實際公差2", FIELD_REAL_DIFF_TWO_XY,		PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1579 },
		
			{ L"正面判斷級別",		FIELD_FRONT_LEVEL,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1580 },
			{ L"正面判斷代碼",		FIELD_FRONT_CODE,			PLC_TYPE_STRING,	ACTION_RESULT,		30,		L"D",		ctBASE_ADDRESS + 1581 },
			{ L"正面缺陷九宮格位置",FIELD_FRONT_LOCATION,		PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1601 },
			{ L"反面判斷級別",		FIELD_BACK_LEVEL,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1602 },
			{ L"反面判斷代碼",		FIELD_BACK_CODE,			PLC_TYPE_STRING,	ACTION_RESULT,		30,		L"D",		ctBASE_ADDRESS + 1603 },
			{ L"反面缺陷九宮格位置",FIELD_BACK_LOCATION,		PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1623 },
			{ L"尺寸判斷級別(G10)", FIELD_SIZE_G10,				PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1624 },
			{ L"尺寸判斷級別(G12)", FIELD_SIZE_G12,				PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1625 },
			{ L"尺寸判斷級別(G14)", FIELD_SIZE_G14,				PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1635 },
			{ L"尺寸檢測備好",		FIELD_SIZE_INFO_1,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1626, 0, 0  },
			{ L"尺寸檢測運行",		FIELD_SIZE_INFO_2,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1627, 0, 0  },
			{ L"CCD準備好",			FIELD_CCD_INFO_1,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1628, 0, 0  },
			{ L"CCD運行",			FIELD_CCD_INFO_2,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1629, 0, 0  },
			{ L"CCD故障",			FIELD_CCD_ERROR_1,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1630, 0, 0  },
			{ L"尺寸故障",			FIELD_SIZE_ERROR_1,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1631, 0, 0  },

			{ L"指令收到",			FIELD_COMMAND_RECEIVED,		PLC_TYPE_WORD,		ACTION_NOTIFY,		2,		L"D",		ctBASE_ADDRESS + 1632 },
			{ L"檢驗結果",			FIELD_RESULT,				PLC_TYPE_WORD,		ACTION_NOTIFY,		2,		L"D",		ctBASE_ADDRESS + 1633 },
			{ L"檢驗結果收到",		FIELD_RESULT_RECEIVED,		PLC_TYPE_WORD,		ACTION_NOTIFY,		2,		L"D",		ctBASE_ADDRESS + 1634 },

			{ L"小版物料級別",		FIELD_RESULT_LEVEL,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1641 },
			{ L"小版AA級數量",		FIELD_RESULT_AA,			PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1642 },
			{ L"小版A級數量",		FIELD_RESULT_A,				PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1643 },
			{ L"小版P級數量",		FIELD_RESULT_P,				PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1644 },
			{ L"訂單合格率",		FIELD_RESULT_QUALIFYRATE,	PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1645 },
			{ L"級差實際檢測值",	FIELD_RESULT_DIFF_XY,		PLC_TYPE_WORD,		ACTION_RESULT,		2,		L"D",		ctBASE_ADDRESS + 1646 },
...
PLC_DATA_ITEM_* CSystCCLProcessSUZHOU::GetPLCAddressInfo(int nFieldId, BOOL bSkip)
{
...
void CSystCCLProcessSUZHOU::DoWriteResult(BATCH_SHARE_SYST_RESULTCCL &xData)
{
...
void CSystCCLProcessSUZHOU::DoSetInfoField(BATCH_SHARE_SYST_INFO &xInfo)
{
	WORD wTemp = 0;
...
void CSystCCLProcessSUZHOU::SetMXParam(IActProgType *pParam, BATCH_SHARE_SYSTCCL_INITPARAM &xData)
{
	if (pParam){
#ifdef OFF_LINE
		...
		pParam->put_ActCpuType(CPU_Q06CPU);
