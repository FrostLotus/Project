...
CSystCCLProcessDONGGUAN_SONG8::CSystCCLProcessDONGGUAN_SONG8()
{
	...
	{
		//概念為ctSYST_PLC_FIELD = m_pPLC_FIELD_INFO
...
{
	if (nFieldId >= 0 && nFieldId <= FIELD_MAX) //範圍內
	{
...
///<summary>設置MXConponent參數</summary>
...
void CSystCCLProcessDONGGUAN_SONG8::DoCustomAction()
{
