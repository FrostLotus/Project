...
#ifdef OFFLINE_DEBUG
	int nCustomerType = CUSTOMER_SYST_PP, nSubCustomerType = SUB_CUSTOMER_DONGGUAN_SONG8;
	OnCmdGPIO(WM_CUSTOMERTYPE_INIT, nCustomerType << 8 | nSubCustomerType);
	OnCmdGPIO(WM_AOI_RESPONSE_CMD, WM_OPC_PARAMINIT_CMD);
#endif
}
